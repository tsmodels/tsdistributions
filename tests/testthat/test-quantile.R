...
test_that("qghst", {
    ...
    median_r = median(r)
    median_q <- qsghst(0.5, mu = 0.01, sigma = 1, skew = -20, shape = 5)
    p <- psghst(median_q, mu = 0.01, sigma = 1, skew = -20, shape = 5)
...
test_that("qnig", {
    ...
    median_r = median(r)
    median_q <- qsnig(0.5, mu = 0.1, sigma = 1, skew = -0.8, shape = 4)
    p <- psnig(median_q, mu = 0.1, sigma = 1, skew = -0.8, shape = 4)
